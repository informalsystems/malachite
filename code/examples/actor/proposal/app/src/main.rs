...
use informalsystems_malachitebft_actor_app_proposal::codec::ProtobufCodec;
use informalsystems_malachitebft_actor_app_proposal::node::{ActorNode, ConfigSource};
...
pub fn main() -> color_eyre::Result<()> {
    ...
    match &args.command {
        Commands::Start(cmd) => {
            ...
            let node = ActorNode::new(home_dir, ConfigSource::File(config_file), cmd.start_height);
        ...
        Commands::Init(cmd) => {
            ...
            let node = &ActorNode::new(home_dir.clone(), ConfigSource::Default, None);
