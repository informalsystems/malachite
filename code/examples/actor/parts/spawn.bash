...
if [[ -z "$APP_BINARY" ]]; then
    APP_BINARY="informalsystems_malachitebft_actor_app_with_parts"
fi
...
export MALACHITE__MEMPOOL__LOAD_UNIFORM__COUNT="5"
...
#export RUST_LOG="informalsystems_malachitebft=debug,mempool=warn,libp2p_network=warn"
