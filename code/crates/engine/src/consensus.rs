...
impl Timeouts {
    ...
    fn increase_timeout(&mut self, step: TimeoutKind) {
        ...
        match step {
            ...
            TimeoutKind::PrevoteRebroadcast => c.timeout_prevote += c.timeout_prevote_delta,
            TimeoutKind::PrecommitRebroadcast => c.timeout_precommit += c.timeout_precommit_delta,
        };
    }
}
