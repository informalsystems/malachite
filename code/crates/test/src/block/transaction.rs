...
impl proto::Protobuf for Transaction {
    type Proto = crate::proto::Transaction;

    fn from_proto(proto: Self::Proto) -> Result<Self, proto::Error> {
        use crate::proto::transaction::Txn;
    ...
    fn to_proto(&self) -> Result<Self::Proto, proto::Error> {
        use crate::proto::transaction::{Dummy, Txn};
...
impl proto::Protobuf for Transactions {
    type Proto = crate::proto::Transactions;
